...
**Live demo:** [srikarjy025-aletheia.hf.space](https://srikarjy025-aletheia.hf.space) (password-protected — request access). Real Claude Sonnet 4.5 reasoning against real, live PubMed retrieval via the bundled Biolab MCP server, with a real bundled Postgres+pgvector store.
